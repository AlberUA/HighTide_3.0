        ...
        window.onload = function() {
            ...
            if (buttonsNavCategories.length != 0 || buttonsNavFaq.length != 0) {
                ...
                function clickBlog(e) {
                    ...
                    const activeElementFaq = document.querySelector(".tabs-faq__title.active");
                    ...
                    if (activeElement) activeElement.classList.remove("active"); else if (activeElementFaq) activeElementFaq.classList.remove("active");
