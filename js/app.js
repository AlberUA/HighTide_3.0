(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".items-cases__slider")) new swiper_core_Swiper(".items-cases__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-cases__button-prev",
                    nextEl: ".slider-cases__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        window.onload = function() {
            ...
            const buttonsNavFaq = document.querySelectorAll(".tabs-faq__title");
            if (buttonsNavCategories.length != 0 || buttonsNavFaq.length != 0) {
                const elementsItems = document.querySelectorAll(".categories-featured__item");
                const elementsItemsFaq = document.querySelectorAll(".questions-faq__item");
                elementsItems.forEach((el => {
                    el.classList.add("show");
                }));
                elementsItemsFaq.forEach((elFaq => {
                    elFaq.classList.add("show");
                }));
                document.addEventListener("click", clickBlog);
                function clickBlog(e) {
                    const targetElement = e.target;
                    document.querySelector(".tabs-featured__title.active");
                    document.querySelector(".tabs-faq__title.active");
                    const items = document.querySelectorAll(".tabs-featured__title");
                    const itemsFaq = document.querySelectorAll(".tabs-faq__title");
                    const elements = document.querySelectorAll(".categories-featured__item");
                    const elementsFaq = document.querySelectorAll(".questions-faq__item");
                    const elementType = targetElement.dataset.filter;
                    if (targetElement.classList.contains("tabs-featured__title") || targetElement.classList.contains("tabs-faq__title")) {
                        items.forEach((item => {
                        ...
                        elementsFaq.forEach((elementFaq => {
                            !elementType || elementFaq.dataset.filter === elementType ? elementFaq.classList.add("show") : elementFaq.classList.remove("show");
                        }));
                    }
                }
            }
